...
export default function Anime() {
  ...
  const getPlaylists = useCallback(async () => {
    setLoading(true);
    setError(null);
    const songIds = "19XErCuH,19XErCuH,yoW5Mgs-,6Vg3meV3,nY3q9CWE,KgPksvcm,PMwvwzIZ,X4w4-D1e,pj10GvSL,IcBh9pP-,eOjFjlhG,Ar5RBJhC,H_PkRV-m,VcMRF5mb,iwxWtBPn,euMlaY0x,PQ3nnsqg,VBXpcgKk,VjosI6AT,GIoh0EIH,duk_018c"; // Add more song IDs if needed
