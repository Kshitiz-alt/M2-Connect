...
export default function Anime() {
  ...
  const getPlaylists = useCallback(async () => {
    setLoading(true);
    setError(null);
    const songIds = "z4t7KMUi,vN7JbuxG,VF5i54E8,Uiywv8d6,Y9EWWjlU,o086jCFK,yZf8AKQu,N7Q5KdJt"; // Add more song IDs if needed
    ...
    <div className="Anime">
      <nav className="navbar bg-body-tertiary">
        <div className="Navbar">
          <button className="Mainpage" data-back="Go Back" data-front="DJ remix" onClick={() => navigate('/About')}></button>
